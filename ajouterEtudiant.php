...
<div class="jumbotron">
 ...
 <form id="myForm" method="POST" >
     ...
     <input type="number" id="cin" name="cin"  class="form-control" required pattern="[0-9]{8}" title="8 chiffres"/>
    </div>
     <!--Password-->
     <div class="form-group">
    ...
    <div class="form-group">
     ...
     <input type="text" id="adresse" name="adresse" rows="10" cols="30" class="form-control" required>
  </input>
    </div>
     <!--Bouton Ajouter-->
     <button type="button" class="btn btn-primary "style="background-color:#3D5AFE;"onclick="ajouter()">Ajouter</button>
     <div id="demo"> </div>
    <a href="ajouterEtudiant.php"> ajouter un autre Etudiant</a>
     </form> 
</div>
   ...
   <script>
    function ajouter()
    {
        ...
        var url="http://localhost/mini-projet-info1_enicar/ajouter.php";
        ...
        xmlhttp.onreadystatechange=function()
            {   
                ...
                // alert(this.responseText);
                    ...
                    {
                        document.getElementById("demo").innerHTML="L'étudiant est déjà inscrit, veuillez de vérifier le CIN";
