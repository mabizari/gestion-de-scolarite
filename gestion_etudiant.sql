...
--
-- Index pour la table `triplet`
--
ALTER TABLE `triplet`
  ADD PRIMARY KEY (`login`,`module`,`classe`);
...
CREATE TABLE `absence`(
  ...
  `justification` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `absence`
  ADD PRIMARY KEY (`cin`,`date`,`heure`);