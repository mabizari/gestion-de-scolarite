...
<main role="main">
        <div class="jumbotron">
            <div class="container">
              <h1 class="display-4"> la liste d'étudiants par groupe</h1>
...
<label for="classe">Choisir un:</label><br>
...
var but = e.value;
        ...
        var url = "http://localhost/mini-projet-info1_enicar/afficherParClasse.php?but="+but;
        //Envoie de la requete
