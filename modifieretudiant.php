...
<p>
 <form id="myForm" method="POST" action="" >
    ...
    <p>remplir les nouveaux coordonnées :  </p><br>
     <!--Nom-->
     <div class="form-group">
 ...
 if (isset($_REQUEST['classe'])&&isset($_REQUEST['adresse'])&&isset($_REQUEST['prenom'])&&isset($_REQUEST['nom'])&&isset($_REQUEST['nom'])&&isset($_REQUEST['prenom']))
{
 ...
 include("connexion.php");
         ...
         if ( $erreur =="OK")
         { echo '<h5 class =container style="color:limegreen;">La modification du letudiant a été bien effectué</h5>';}
         else {
           echo '<h5 class=container style="color:red;">étudiant non existant</h5>';
         }
