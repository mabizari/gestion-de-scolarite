...
<div class="jumbotron">
 ...
 <form id="myForm" method="POST" >
     ...
     <input type="text" id="module" name="module" class="form-control" required autofocus>
    </div>
    ...
    <br/>
     ...
     <a href="ajouterGroupe.php">                        ajouter un autre Groupe</a>
     </form> 
</div>
<br/>
     <br/>
   ...
   <script>
    function ajouter()
    {
        ...
        var url="http://localhost/mini-projet-info1_enicar/ajouter2.php";
        ...
        xmlhttp.onreadystatechange=function()
            {   
                ...
                // alert(this.responseText);
                    ...
                    {
                        document.getElementById("demo").innerHTML="Le groupe existe déjà , merci de vérifier les données";
